...
module ApplicationHelper
  ...
  def section_header(n, options = {}, &block)
    tip_tag = options[:no_tip] ? nil : tip(t(".step_#{n}.instruction"), t(".step_#{n}.tip"))
    ...
    header  = content_tag(:header, [
      content_tag(:h1, t(".step_#{n}.title")),
      content_tag(:h2, t(".step_#{n}.instruction"), :class => el_class),
      tip_tag,
      content_tag(:p, t(".step_#{n}.summary"), :class => el_class),
      additional_content
    ].compact)
